 ...
 *    ('players1Final') containing all the original teaml players plus 'Thiago', 'Coutinho' and 'Perisic'.
 *
 * 5. Based on the game.odds object, create one variable for each odd (called 'team1', 'draw' and 'team2').
 *
 * 6. Write a function ('printGoals') that receives an arbitrary number of player names (NOT an array)
 *    and prints each of them to the console, along with the number of goals who were scored (number of player names passed in).
 *
 ...
 *  Then, call the function again with players from game.scorerd
 *
 * GOOD LUCK
 *
 */
